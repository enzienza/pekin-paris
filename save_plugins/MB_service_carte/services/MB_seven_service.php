...
function MB_seven_service($POST){
    ...
    ?>
        ...
        <div class="">
            <label for="titre_seven_service">Titre </label>
            <input type="text" class="widefat" id="titre_seven_service" name="titre_seven_service" value="<?php echo $titre_seven_service ?>" />
        </div>
