...
function MB_nine_service($POST){
	...
	$display_nine_service = get_post_meta($POST->ID, 'display_nine_service', true);
    ...
    ?>
		...
		<div class="head-metabox" style="border-bottom: 1px solid #ddd; margin-bottom: 1.5rem;">
	        <div style="line-height: 5;">
	            <label for="display_nine_service" style="margin-right: 15px; font-weight: bold;">Afficher le service : </label>
	            <span style="margin-right: 15px;"><input type="radio" <?php checked($display_nine_service, 'oui'); ?> name="display_nine_service" value="oui"/>Oui</span>
	            <span style="margin-right: 15px;"><input type="radio" <?php checked($display_nine_service, 'non'); ?> name="display_nine_service" value="non"/>Non</span>
	        </div>

	        <div  style="margin-bottom: 2rem;">
	            <label for="titre_nine_service" style="margin-right: 1rem; font-weight: bold;">Titre </label>
	            <input type="text" id="titre_nine_service" name="titre_nine_service" value="<?php echo $titre_nine_service ?>" style="width: 90%;" />
	        </div>
	    </div>
...
function save_MB_nine_service($POST_ID){
	...
	// Title : titre_nine service
	if(isset($_POST['titre_nine_service'])){
        update_post_meta($POST_ID, 'titre_nine_service', $_POST['titre_nine_service']);
    }

	// Radio : affiche_nine_servie
	if(isset($_POST['display_nine_service'])){
	    update_post_meta($POST_ID, 'display_nine_service', $_POST['display_nine_service']);
	}

	// repeatable : repeat_nine_service
