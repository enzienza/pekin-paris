...
function MB_fourteen_service($POST){
    ...
    ?>
        ...
        <div class="">
            <label for="titre_fourteen_service">Titre </label>
            <input type="text" class="widefat" id="titre_fourteen_service" name="titre_fourteen_service" value="<?php echo $titre_fourteen_service ?>" />
        </div>
