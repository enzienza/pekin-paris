...
function MB_fifteen_service($POST){
    ...
    ?>
        ...
        <div class="">
            <label for="titre_fifteen_service">Titre </label>
            <input type="text" class="widefat" id="titre_fifteen_service" name="titre_fifteen_service" value="<?php echo $titre_fifteen_service ?>" />
        </div>
