...
function MB_twelve_service($POST){
    ...
    ?>
        ...
        <div class="">
            <label for="titre_twelve_service">Titre </label>
            <input type="text" class="widefat" id="titre_twelve_service" name="titre_twelve_service" value="<?php echo $titre_twelve_service ?>" />
        </div>
