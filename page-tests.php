...
<section class="container">
    ...
    <div class="btn-tarif">
        <div class="row">
            <div class="col-6">
                <button class="btn btn-left collapsed" type="button" data-toggle="collapse" data-target="#tarif_sans_midi" aria-expanded="false" aria-controls="tarif_avec_midi">
                    Midi
                </button>
            </div>
            <div class="col-6">
                <button class="btn btn-right collapsed" type="button" data-toggle="collapse" data-target="#tarif_sans_soir" aria-expanded="false" aria-controls="tarif_avec_midi">
                    Soir
                </button>
            </div>
        </div>
